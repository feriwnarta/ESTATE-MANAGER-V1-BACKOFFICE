        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (waktu == '1hr') {
                    ...
                    let totalPersen = 36500;
                    totalPersen = totalPersen - data.total;
                    totalPersen = Math.round(totalPersen / 365);
                    $('#' + idCard + ' h3').html(totalPersen + ' %');
                }
                ...
                if (waktu == '1hr') {
                    ...
                    jamSekarang1 = 9125 - data.jam_sekarang_1;
                    jamSekarang2 = 9125 - data.jam_sekarang_2;
                    jamSekarang3 = 9125 - data.jam_sekarang_3;
                    jamSekarang4 = 9125 - data.jam_sekarang_4;
                }

                // logic persentase dri kmren
                if (data.persentase == 0) {
                    $('#' + idCard + ' p' + '#' + idCard).hide();
                    $('#' + idCard + ' object').hide();
                } else {
                    if (data.persentase > 0) {
                        $('#' + idCard + ' p' + '#' + idCard).html(data.persentase + '%');
                        $('#' + idCard + ' object').replaceWith(
                            '<object data="assets/img/icon/arrow-up.svg"></object>'
                        );
                    } else {
                        $('#' + idCard + ' p' + '#' + idCard).html(data.persentase);
                        $('#' + idCard + ' object').replaceWith(
                            '<object data="assets/img/icon/arrow-down.svg"></object>'
                        );
                ...
                if (waktu == '1hr') {
                    ...
                    if (jamSekarang1 == 9125 && jamSekarang2 == 9125 && jamSekarang3 == 9125 && jamSekarang4 == 9125) {
                        borderColorChart = 'rgb(67, 240, 56)';
                        fillColorChart = 'rgba(35, 240, 9, 0.1)'
                        // $('#' + idCard + ' p' + '#' + idCard).remove();
                        // $('#' + idCard + ' object').remove();
